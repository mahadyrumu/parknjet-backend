<div x-data="{ show: true }" x-show="show" x-transition x-init="setTimeout(() => show = false, 10000)" {{ $attributes->merge(['class' => 'p-4 bg-red-300/20 flex justify-between rounded border border-red-400 text-lg mb-8']) }}>
