...
<body>
    <div class="container">
        ...
        <p>You have changed your email address with us.</p>
        <p>Your previous email was - {{ $previousEmail }}<br>
            Your current email is - {{ $user->user_name }}</p>
        <p>If you did not make this change please contact our support team.</p>
        <p style="text-align: center"><a href="mailto:service@parknjetseatac.com" class="button"
                style="color: white">Support Email</a></p>
        <div class="footer">
