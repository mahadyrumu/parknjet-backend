    ...
    <div class="flex flex-wrap items-center justify-center lg:justify-between">
        <div class="w-full md:w-8/12 lg:w-5/12">
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="password" class="block mt-1 w-full bg-transparent" type="password"
            ...
            <div class="flex items-center my-3 lg:hidden">
        ...
        <div>
            <div class="flex flex-col">
                <div class="md:inline-block lg:ml-2 lg:h-[80px] lg:min-h-[1em] lg:w-0.5 bg-gray-400">
                </div>
                <div class="lg:inline-block lg:py-2 lg:min-h-[1em] text-gray-600 hidden">
                    or
                </div>
                <div class="lg:inline-block lg:ml-2 lg:h-[80px] lg:min-h-[2em] lg:w-0.5 bg-gray-400">
                </div>
            </div>
        </div>
        <div class="w-full md:w-8/12 lg:w-5/12">
            ...
            <a href="{{ route('register') }}"
                class="w-full flex justify-center items-center bg-gray-600 hover:bg-gray-500 mt-3 border-gray-600 p-2.5 border text-white font-semibold text-center text-base shadow-md rounded-lg">
                <svg class="mr-2 -ml-1 w-5 h-5" style="color: rgb(232, 232, 232);" width="45" height="45"
                    viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M44 24V9H24H4V24V39H24" stroke="#333" stroke-width="1" stroke-linecap="round"
                        stroke-linejoin="round" fill="#e8e8e8"></path>
